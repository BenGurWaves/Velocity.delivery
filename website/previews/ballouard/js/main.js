...
function openModalWithAutoClose() {
    modal.classList.add('is-active');
    lenis.stop();
...
// ========================================
// Loading Sequence — LB Monogram Coiling Animation
// ========================================
...
// LB monogram "coils" itself - L starts first, then B follows with 0.1s stagger
loadingTimeline
    .to('.loader__path--l', {
        strokeDashoffset: 0,
        duration: 1.8,
    ...
    // Brief pause after monogram is drawn
    .to({}, { duration: 0.8 })
    // Fade out monogram
    .to('.loader__path', {
        opacity: 0,
