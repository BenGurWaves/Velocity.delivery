...
var VALID_STATUSES, STATUS_EMAIL;
  ...
  "api/leads/admin-update.js"() {
    ...
    STATUS_EMAIL = {
      accepted: {
        ...
        body: /* @__PURE__ */ __name((name, dashUrl) => emailShell(`
    ...
    `), "body")
      ...
      completed: {
        ...
        body: /* @__PURE__ */ __name((name, dashUrl, siteLink) => emailShell(`
    ...
    `), "body")
      ...
      declined: {
        ...
        body: /* @__PURE__ */ __name((name) => emailShell(`
...
async function onRequestGet2(context) {
  ...
  const row = /* @__PURE__ */ __name((k, v) => v ? `<tr><td style="padding:6px 16px 6px 0;color:#888;font-size:13px;white-space:nowrap;vertical-align:top">${k}</td><td style="padding:6px 0;font-size:13px;color:#e8ddd3;vertical-align:top">${esc(String(v))}</td></tr>` : "", "row");
  const section = /* @__PURE__ */ __name((title, rows2) => rows2 ? `<div style="margin:0 0 32px"><div style="font-size:10px;letter-spacing:.18em;text-transform:uppercase;color:#C49C7B;margin-bottom:10px">${title}</div><table style="border-collapse:collapse;width:100%">${rows2}</table></div>` : "", "section");
...
//# sourceMappingURL=functionsWorker-0.19813631199542037.mjs.map
